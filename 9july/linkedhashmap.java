		...
		public static void main(String[] args) {
			...
			while (true) {
				...
				case 1:
					...
					keyval = sc.nextInt();
					dataval = sc.nextInt();
					linkedHashMapCustom.put(keyval, dataval);
					break;
				case 2:
					int remkey = sc.nextInt();
					if(linkedHashMapCustom.remove(remkey))
						System.out.println("Deleted Successfully");
					else
						System.out.println("Delele operation unsuccessful");
					;
					break;
				case 3:
					int getkey = sc.nextInt();
					if (linkedHashMapCustom.get(getkey) != null)
						System.out.println(linkedHashMapCustom.get(getkey));
					else
